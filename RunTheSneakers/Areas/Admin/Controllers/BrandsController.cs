...
namespace RunTheSneakers.Areas.Admin.Controllers
{
    public class BrandsController : BaseAdminController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,BrandLogoUrl")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,BrandLogoUrl")] Brand brand)
        {
            if (id != brand.Id)
            {
                return NotFound();
